...
class hr_indicadores_previsionales(models.Model):
    ...
    def update_document(self):
        ...
        try:
            ...
            self.contrato_plazo_fijo_empleador            = new_ind['SEGURO_CESANTIA_PLAZO_FIJO'][2]
            self.contrato_plazo_indefinido_empleador_otro = new_ind['SEGURO_CESANTIA_11_ANNOS'][3]
