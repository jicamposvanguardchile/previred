...
class hr_indicadores_previsionales(models.Model):
    ...
    def update_document(self):
        ...
        self.contrato_plazo_fijo_empleador            = new_ind['SEGURO_CESANTIA_PLAZO_FIJO'][0]
        ...
        for tabla in tablas:
            for fila in tabla.find_all('tr'):
             ...
             #   indicadores['UF']['ABRIL'] = extraer_monto(texto_raw)
                ...
                if 'plazo indefinido 11 años o mas(*)' in texto and not indicadores['SEGURO_CESANTIA_11_ANNOS'] == 0:
                    celdas = fila.find_all('td')
                    if len(celdas) >= 2:
